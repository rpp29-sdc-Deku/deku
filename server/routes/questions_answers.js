...
router.get('/initialQA', (req, res) => {
  axios.get('http://18.117.70.219:3030/qa/questions', {
    method: 'GET',
    headers: {
...
router.put('/likeQuestion', (req, res) => {
  axios.put('http://18.117.70.219:3030/likeQuestion', {
    question_id: req.body.id
  })
    .then((response) => {
      return axios.get('http://18.117.70.219:3030/qa/questions', {
        method: 'GET',
        headers: {
          Authorization: apiToken
        },
...
router.put('/likeAnswer', (req, res) => {
  axios.put('http://18.117.70.219:3030/likeAnswer', {
...
router.put('/reportQuestion', (req, res) => {
  axios.put('http://18.117.70.219:3030/reportQuestion', {
    question_id: req.body.id
  }, {
    headers: {
      Authorization: apiToken
...
router.put('/reportAnswer', (req, res) => {
  axios.put('http://18.117.70.219:3030/reportAnswer', {
    answer_id: req.body.id
  }, {
    headers: {
      Authorization: apiToken
...
router.post('/submitQuestion', (req, res) => {
  axios({
    method: 'POST',
    url: 'http://18.117.70.219:3030/submitQuestion',
    headers: {
      Authorization: apiToken
    },
    data: req.body
...
router.post('/submitAnswer', (req, res) => {
  ...
  axios({
    method: 'POST',
    url: 'http://18.117.70.219:3030/submitAnswer',
    headers: {
      Authorization: apiToken
    },
    data: answerForm
